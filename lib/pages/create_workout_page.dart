...
class create_workout extends StatefulWidget {
  const create_workout({Key? key}) : super(key: key);

  @override
  State<create_workout> createState() => _createWorkoutState();
}

class _createWorkoutState extends State<create_workout> {
  final myController = TextEditingController();
  final maxExercises = 100;
    ...
    return Scaffold(
      ...
      body: Column(children: <Widget>[
        ...
        Expanded(
          ...
          itemCount:
              exercises.length < maxExercises ? exercises.length : maxExercises,
  ...
  void _sendDataBack(BuildContext context) {
    ...
    if (tempW != null && myController.text.isNotEmpty) {
      ...
      Navigator.pop(context, Workout('New Workout', exercises));
    }
  }
  ...
  void submitCreateExercise(int sets, int reps) {
    ...
    Exercise e = Exercise(
        _exerciseController.text, _notesController.text.trim(), sets, reps, s, m);
    setState(() {
      exercises.add(e);
    });
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: RawMaterialButton(
                              onPressed: () {
                                setState(() {
                                  if (exercises.elementAt(index).sets > 0) {
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: RawMaterialButton(
                              onPressed: () {
                                setState(() {
                                  if (exercises.elementAt(index).reps > 0)
                          ...
                          Flexible(
                              child: NumberPicker(
                                  ...
                                  onChanged: (value) => setState(() =>
                                      exercises.elementAt(index).min = value))),
                          Flexible(
                              child: NumberPicker(
                                  zeroPad: true,
                                  infiniteLoop: true,
                                  ...
                                  onChanged: (value) => setState(() =>
                                      exercises.elementAt(index).sec = value))),
                        ],
                      ),
                    ),
                    const SizedBox(
